				...
				<nav class="navbar navbar-default yamm">
				    <div class="container-fluid">
				        <div class="navbar-header">
							...
							<div class="navbar-brand"><a  href="index.html"><img src="<?php echo base_url('resources/images/commerce.png');?>" height="50px;"> <span><b style="color:#0000aa">Equicksales</b></a></span></div>
				        </div>
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<div class="panel panel-default about-widget">
							<h3>Edit Basic and Login details</h3>
							<div class="panel-body">
								<form method="post" action="<?php echo site_url('platform/edit_profile');?>">
									<div class="input-group" style="width:100%">
										<label for="fullname">Name</label>
										<input type="text" class="form-control" name="name" style="border-color:lightblue"value="<?php echo $user;?>">
									</div>
