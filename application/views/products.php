...
<head>
    ...
    <meta name="keywords" content="Products, Eshop, Emedics">
    <meta name="description" content="Equicksales consulting Ltd. has stunning software products including eshop, emedics and the equicksales platform">
			...
			<div class="container">
				<div class="row">	
					<div class="col-md-10 col-md-offset-1 col-sm-12 text-center">
						...
						<p class="lead">We have stunning software products<br>Our products are designed to meet the need of our clients</p>
					</div><!-- end col -->
				</div><!-- end row -->
			</div><!-- end container -->
		</section><!-- end section -->
				...
				<div class="row">
					<div class="col-md-6">
						<div class="about-widget">
							...
							<p>Our Equicksales platform is a platform for marketing and sales of products and services. As a business you can advertise you product or service on this platform to reach your customers. As a customer you can find products or services you want to patronize</p>
					...
					<div class="col-md-6">
						<div class="about-widget">
							<i class="flaticon-cup"></i>
							<h3>Eshop</h3>
							<p>Eshop is a shop management system for managing shops and supermarkets. You can use it to manage inventory sales and administration of your shop</p>
				...
				<div class="row">
					<div class="col-md-6">
						<div class="about-widget">
							<i class="flaticon-cup"></i>
							<h3>Emedics</h3>
							<p>Emedics is a hospital management system. You can use it to manage the day to day activities of a hospital. It has features for managing patients and dispensary records and medical consultation</p>
