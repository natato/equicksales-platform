				    ...
				    <div class="container-fluid">
				        ...
				        <div id="navbar" class="navbar-collapse collapse">
				            <ul class="nav navbar-nav navbar-right">
				                <li class=""><a href="<?php echo site_url('site/signin');?>">Sign In</a></li>
			...
			<div class="container">
				<div class="row">	
					<div class="col-md-10 col-md-offset-1 col-sm-12 text-center">
						<h2>Sign In to Equicksales Platform</h2>
							...
							<div class="col-md-10 col-md-offset-1">
								<div class="about-img">
									<div class="panel panel-default about-widget">
										...
										?><br>
										<h3>Equicksales Sign In</h3>
										<div class="panel-body">
											<form method="post" action="<?php echo site_url('platform/signin');?>">
												<div class="input group">
													<label for ="email">Email</label>
													<input class="form-control" type="email" name="email" placeholder="Enter Email" style="border-color:lightblue" required>
												</div>
												<div class="input group">
												...
												<div class="input group">
													<input class="btn btn-primary" type="submit" value="Sign In" id="signin">
													<a href="<?php echo site_url('site/passwordreset');?>"><button type="button" class="btn btn-primary" type="button" id="password_reset">Reset Password</button></a>
											...
											<div class="signin" data-value="<?php echo site_url('platform/signin');?>"> </div>
											<div class="home" data-value="<?php echo site_url('platform/index');?>"> </div>
										</div>
									</div>
								</div>
							</div>
