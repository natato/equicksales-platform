					...
					<div class="col-md-6 col-md-offset-3">
							  ...
							  <div class="modal-dialog">
							    ...
							    <div class="modal-content">
							      <div class="modal-header bg-info">
							        ...
							        <h4 class="modal-title">Advert Published</h4>
							      </div>
						...
						<div class="panel panel-default about-widget">
							...
							<div class="panel-body">
								<form method="post" action="<?php echo site_url('platform/newadvert');?>" enctype="multipart/form-data">
									<div class="input-group" style="width:100%">
										<label for="title">Advert Title</label>
										<input type="text" class="form-control" name="title" style="border-color:lightblue" required>
									</div>
									<div class="input-group" style="width:100%">
										<label for="description">Description</label>
										<textarea class="form-control" name="description" style="border-color:lightblue" required rows=6></textarea>
									</div>
									<div class="input-group" style="width:100%">
										<label for="contactperson">Contact Person</label>
										<input type="text" class="form-control" name="contactperson" style="border-color:lightblue" required>
									</div>
									<div class="input-group" style="width:100%">
										<label for="contact">Contact</label>
										<input type="text" class="form-control" name="contact" style="border-color:lightblue" required>
									</div>
								
									<div class="input-group" style="width:100%">
										<input type="submit" class="btn btn-primary" id="advertise" value="Advertise">
									</div>
								</form>
							</div>
						</div>
